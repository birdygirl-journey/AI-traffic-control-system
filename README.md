...
=Counts the number of vehicles on each road
=Identifies the road with the highest traffic density
=grants a green signal to the busiest road
=Repeats the process across multiple traffic cycles
The logic mimics real-world AI decision-making using simple Python constructs.
...
(No external libraries required — beginner friendly)


🔮 Future Enhancements

Integrate real-time camera or sensor data
Implement machine learning models
Add emergency vehicle priority
Expand to multi-intersection networks
Visualize traffic using a GUI
